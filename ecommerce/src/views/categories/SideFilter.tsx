...
function SideFilter() {
  return (
    <>
      <article className="sidebar-filter">
        <article className="products-route-categories">
          <p>
            Home{" "}
          </p>
        ...
        <article className="sidebar-style">
          ...
          <article className="price-filter">
            <article className="price-filter-title">
              <p>Price</p>
              <img src="/assets/up-sight.svg" alt="" />
            </article>
            <div className="range-track"></div>
            <article className="price-balls">
                <div className="price-balls-min"></div>
                <div className="gap-balls"></div>
                <div className="price-balls-max"></div>
            </article>
            <article className="filter-prices">
              <p>$50</p>
              <p>$200</p>
            </article>

          </article>
          <article className="colors-filter">
            <article className="colors-filter-title">
              <p>Color</p>
              <img src="/assets/up-sight.svg" alt="" />
            </article>
            <div className="category-color-options">   
              <div className="category-circle-1"></div>
              <div className="category-circle-2"></div>
              <div className="category-circle-3"></div>
              <div className="category-circle-4"></div>
              <div className="category-circle-5"></div>
              <div className="category-circle-6"></div>
              <div className="category-circle-7"></div>
              <div className="category-circle-8"></div>
              <div className="category-circle-9"></div>
              <div className="category-circle-10"></div>
            </div>
          </article>
          <article className="size-filter">
            <article className="size-filter-title">
              <p>Size</p>
              <img src="/assets/up-sight.svg" alt="" />
            </article>

            <article className="category-size-btn">
              <div className="xx-small-button">
                <button className="x-btn">XX-Large</button>
              </div>
              <div className="x-small-button">
                <button className="x-btn">X-Large</button>
              </div>
              <div className="small-button">
                <button className="s-btn">Small</button>
              </div>
              <div className="medium-button">
                <button className="l-btn">Medium</button>
              </div>
              <div className="large-button">
                <button className="s-btn">Large</button>
              </div>
              <div className="x-large-button">
                <button className="l-btn">X-Large</button>
              </div>
              <div className="xx-large-button">
                <button className="x-btn">XX-Large</button>
              </div>
              <div className="3x-large-button">
                <button className="x-btn">3X-Large</button>
              </div>
              <div className="4x-large-button">
                <button className="x-btn">4X-Large</button>
              </div>
            </article>
          </article>
          <article className="dress-style-types">
          <article className="dress-style-option-title">
              <p>Dress Style</p>
              <img src="/assets/up-sight.svg" alt="" />
            </article>
            <article className="dress-style-option">
              <p>Casual</p>
              <img src="/assets/right-sight.svg" alt="" />
            </article>
            <article className="dress-style-option">
          ...
          <article className="apply-filter">
